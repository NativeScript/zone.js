...
// Excluded because it assumes something about global setTimeout patch
// that does not hold for {N} platform.
...
// Apparently Zone.js thinks that {N} is a node compatible env. Skip fake-async tests
